...
def sanitize_database(source: Path, destination: Path) -> dict[str, int]:
    ...
    update_rows(
        ...
        "candidates",
        {
            ...
            "description": "",
            "metadata_json": sanitize_json_column,
        },
    )
    update_rows(
        connection,
        "events",
        {"candidate_id": candidate_id, "payload_json": sanitize_json_column},
    )
    update_rows(
        connection,
        "seen_sources",
    ...
    update_rows(
        ...
        "download_claims",
        {
            ...
            "publisher": person_id,
            "note": "",
            "extra_data": sanitize_json_column,
        },
    )
    update_rows(
        connection,
    ...
    update_rows(
        ...
        "conversion_events",
        {
            ...
            "payload_json": sanitize_json_column,
        },
    )
    update_rows(connection, "performance_snapshots", {"candidate_id": candidate_id})
    update_rows(connection, "feedback_actions", {"candidate_id": candidate_id})
    update_rows(
        connection,
        "trend_runs",
        {
            "keywords_json": sanitize_json_column,
            "keyword_sync_json": sanitize_json_column,
            "error": sanitize_text,
        },
    )
